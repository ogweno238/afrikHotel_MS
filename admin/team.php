...
<body>
		...
		<div class="two-thirds1 column">
			...
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
						...
						<td><?php echo $row['pt_leader']; ?></td>
						<td><a rel="facebox" href="editteam.php?id=<?php echo $row['pt_id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['pt_id']; ?>" class="delbutton" title="Click To Delete">Delete</a></td>
						</tr>
						<?php
							}
						?>
	...
	<div id="footer">
		<div class="copyrights">&copy; 2023 Afrik hotel Management System
</div>
	</div>
