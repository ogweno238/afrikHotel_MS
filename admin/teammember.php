...
<body>
	<div id="top">
		<div class="logo">
			 <span style="float:right; color:#FFFFFF; font-weight:bold; display: inline-block; padding: 20px 0 0 20px;">Hello Administrator</span>
		</div>
	</div>
		...
		<div class="two-thirds1 column">
			...
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
						...
						<?php
							include('../connect.php');
							$result = $db->prepare("SELECT * FROM afrik_member");
							$result->execute();
							for($i=0; $row = $result->fetch(); $i++){
						?>
						<tr class="record">
						<td><?php echo $row['pt_name']; ?></td>
						<td><?php echo $row['prm_member']; ?></td>
						<td><a rel="facebox" href="editteammember.php?id=<?php echo $row['prm_id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['prm_id']; ?>" class="delbutton" title="Click To Delete">Delete</a></td>
						</tr>
						<?php
							}
						?>
	...
	<div id="footer">
		<div class="copyrights">&copy; 2023 Afrik hotel Management System</div>
	</div>
