...
<script src="admin/lib/jquery.js" type="text/javascript"><a rel="facebox" href="details.php?id=<?php echo $row['id']; ?>"><img src="menu/<?php echo $row['image']; ?>" width="150" height="150"></a></script>
...
<body>
	...
	<div id="footer">
  &copy; 2023 Afrik hotel Management System
