...
<strong> </strong><br>
AFRIK HOTEL MANAGEMENT SYSTEM, NAIROBI CITY<br>
Tel. No. 0759478072
</div><br><br>
<?php
include('connect.php');
...
Type of Occasion:<strong></strong><br>
Type of Reservation:<strong><?php echo $row['type_res']; 
$dsdssd=$row['type_res'];
?></strong><br>
Type of Food:<strong><?php echo $row['type_catering']; ?></strong><br>
