...
<div class="content" id="content" style="width: 400px; font-size:11px; font-family:arial; font-weight:normal; margin:0 auto;">
...
Tel. No.07- 1618-9343<br />
<div style="text-align:center; color:#FFFF00; font-style:italic;">(Your Reservation is pending, you may check your reservation status after 2mins. The management will call you or you may keep a copy of your reservation Id for verification.)</div>
</div><br><br>
<?php
include('connect.php');
$res=$_GET['res'];
...
$dsdssd=$row['type_res'];
?></strong><br>
Type of Meal:<strong><?php echo $cat; ?></strong><br>
